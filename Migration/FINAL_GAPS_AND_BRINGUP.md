...
- I2C0 异步传输使用 DMA_CH2/CH3，并由 TX_DONE/RX_DONE 中断推进写、读和重复起始状态。
...
4. 单独接 ICM20948，先读取 WHO_AM_I，再检查静止加速度、角速度和温度；最后接 PB21 INT。
5. 单独接灰度传感器，确认 PA25 ADC 或 I2C 灰度模块的数据顺序与黑白极性。
