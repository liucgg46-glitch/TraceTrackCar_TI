...
TARGET_INSET_NUMERATOR = 1
TARGET_INSET_DENOMINATOR = 14
...
for corner in corners:
    path_x = (
        corner[0] * (
            TARGET_INSET_DENOMINATOR
            - TARGET_INSET_NUMERATOR
        )
        + center_x * TARGET_INSET_NUMERATOR
    ) // TARGET_INSET_DENOMINATOR
    ...
    path_y = (
        ...
        + center_y * TARGET_INSET_NUMERATOR
    ) // TARGET_INSET_DENOMINATOR
